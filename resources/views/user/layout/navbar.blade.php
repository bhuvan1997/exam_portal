...
<nav class="app-header navbar navbar-expand-lg bg-body border-bottom shadow-sm">
   <div class="container-fluid">
      <!-- Brand Logo / Name -->
      <a class="navbar-brand fw-bold text-primary" href="{{ route('user.dashboard') }}">EXAM PORTAL</a>
         ...
         <ul class="navbar-nav mb-2 mb-lg-0 align-items-lg-center">
            ...
            <li class="nav-item dropdown">
               ...
               <ul class="dropdown-menu" aria-labelledby="userDropdown">
                  ...
                  <li><a class="dropdown-item" href="{{ route('user.change_password') }}"><i class="bi bi-key"></i> Change Password</a></li>
